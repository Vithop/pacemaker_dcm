		...
		<div class="row">
			<div class="col">
				<div class="q-pa-md">
					...
					<q-slider v-model.lazy="rateLimit.min" :min="30" :max="50" color="green" label />
					<span class="slider-badge">
						<q-badge color="secondary">Upper rate Limit (50 - 175ppm): {{ rateLimit.max }}</q-badge>
					</span>
					<q-slider v-model="rateLimit.max" :min="51" :max="175" color="green" label />
				</div>
				...
				<div class="q-pa-md" v-if="paceType == 'AOO' || paceType == 'AAI'">
					...
					<q-slider v-model="atricalPulseWidth" :min="0.1" :max="1.9" :step="0.1" color="blue" label />
				</div>
			...
			<div class="col2">
				...
				<div class="q-pa-md" v-if="paceType == 'VOO' || paceType == 'VVI'">
					...
					<q-slider v-model="VentricularPulseAmp" :min="3.5" :max="7.0" :step="0.5" color="red" label />
				</div>
				...
				<div class="q-pa-md" v-if="paceType == 'VOO' || paceType == 'VVI'">
					...
					<q-slider v-model="VentricularPulseWidth" :min="0.1" :max="1.9" :step="0.1" color="red" label />
				</div>
			</div>
		</div>
