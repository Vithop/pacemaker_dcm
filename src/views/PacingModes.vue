<template>
	<div>
      ...
      <div v-for="(paceOption, index) in paceOptions" :key="index">
		...
		<div class="row">
			<div class="col">
				...
				<div class="q-pa-md">
					...
					<q-slider v-model.lazy="lowerRateLimit" :min="30" :max="50" markers :step="5" color="green" label />
					<span class="slider-badge">
        ...
        <div class="q-pa-md" v-if="paceType === 'DOOR'">
        ...
        <div class="q-pa-md" v-if="paceType === 'AOOR' || paceType === 'AAIR' || paceType === 'VOOR' || paceType === 'VVIR' || paceType === 'DOOR'">
				...
				<div class="q-pa-md" v-if="paceType === 'AOO' || paceType === 'AAI' || paceType === 'AOOR' || paceType === 'AAIR'">
					...
					<q-slider v-model="atricalPulseAmp" :min="0.5" :max="3.2" markers :step="0.5" color="blue" label />
				</div>
				...
				<div class="q-pa-md" v-if="paceType == 'AOO' || paceType == 'AAI' || paceType === 'AOOR' || paceType === 'AAIR'">
					...
					<q-slider v-model="atricalPulseWidth" :min="0.1" :max="1.9" markers :step="0.1" color="blue" label />
				</div>
				...
				<div class="q-pa-md" v-if="paceType == 'AAI' || paceType == 'AAIR'">
					...
					<span class="slider-badge">
						<q-badge color="primary">Atrial Refactory Period (150 - 500ms): {{ atricalRefractoryPeriod }}</q-badge>
					</span>
      ...
      <div class="q-pa-md" v-if="paceType == 'VVI' || paceType == 'VVIR'">
					...
					<span class="slider-badge">
						<q-badge color="primary">Ventricular Refactory Period (150 - 500ms): {{ atricalRefractoryPeriod }}</q-badge>
					</span>

					<q-slider
						v-model="ventricularRefractoryPeriod"
						:min="150"
						:max="500"
						markers :step="10"
						color="blue"
			...
			<div class="col2">
				...
				<div class="q-pa-md" v-if="paceType == 'VOO' || paceType == 'VVI'">
					...
					<q-slider v-model="VentricularPulseAmp" :min="3.5" :max="7.0" markers :step="0.5" color="red" label />
				</div>
				...
				<div class="q-pa-md" v-if="paceType == 'VOO' || paceType == 'VVI'">
					...
					<q-slider v-model="VentricularPulseWidth" :min="0.1" :max="1.9" markers :step="0.1" color="red" label />
				</div>
...
export default {
	...
	data: function() {
		return {
			paceType: "AOO",
			paceOptions: ["AOO", "VOO", "AAI", "VVI", "DOO", "AOOR", "AAIR", "VOOR", "VVIR", "DOOR"],
      lowerRateLimit: 30,
      upperRateLimit: 175,
      maxSensorRate: 5,
      fixedAvDelay: 5,
	...
	methods: {
        ...
        this.$store
              ...
              atricalRefractoryPeriod: this.atricalRefractoryPeriod,
              ...
              console.log(this.$store.state.newUsers[this.$store.state.currentUser]);
            })
            .catch((err) =>{
