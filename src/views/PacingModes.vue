        ...
        >
          ...
          <span class="slider-badge">
            <q-badge color="primary">
              Atrial Pulse Amplitude (0.5 - 3.2V):
              {{ atricalPulseAmp }}
            </q-badge>
          </span>
      ...
      if (event) {
        this.$store
          ...
          .then(() => {
            ...
            console.log(
              this.$store.state.newUsers[this.$store.state.currentUser]
            );
          })
          .catch(err => {
